...
class StudentRejectedGatepasses extends StatefulWidget {
  final String userId; // Add userId to fetch specific student's gate passes

  const StudentRejectedGatepasses({super.key, required this.userId});

  @override
  // ignore: library_private_types_in_public_api
  _StudentRejectedRequestsPageState createState() => _StudentRejectedRequestsPageState();
}

class _StudentRejectedRequestsPageState extends State<StudentRejectedGatepasses> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Rejected Gate Passes'),
      ),
      body: StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance
            ...
            .where('request', isEqualTo: -1) // Only rejected requests
            .snapshots(),
